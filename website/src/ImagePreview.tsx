          ...
          <section className='jpegr-card'>
            ...
            <div className='jpegr-kv'>
              <div className='jpegr-k'>
                Max size:{' '}
                <span className='jpegr-v'>{effectiveMaxSizeText}</span>
              </div>
              ...
              <div className='jpegr-k'>
                Final quality:{' '}
                <span className='jpegr-v'>{finalQualityText}</span>
              </div>
            ...
            <section className='jpegr-card'>
              ...
              <div className='jpegr-kv'>
                ...
                <div className='jpegr-v'>
                  <span
                    className={badgeClass(runtimeSupport.HTMLCanvasElement)}
                  >
                ...
                <div className='jpegr-v'>
                  <span
                    className={badgeClass(runtimeSupport.createImageBitmap)}
                  >
